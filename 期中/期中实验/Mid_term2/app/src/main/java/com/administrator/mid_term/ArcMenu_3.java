...
public class ArcMenu_3 extends ViewGroup implements View.OnClickListener {
    ...
    public ArcMenu_3(Context context){this(context,null);}

    public ArcMenu_3(Context context, AttributeSet attrs){
        this(context,attrs,0);
    }

    //开始对控件的子元素进行处理
    public ArcMenu_3(Context context , AttributeSet attrs,int defStyle){
